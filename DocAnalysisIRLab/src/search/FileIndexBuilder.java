...
public class FileIndexBuilder {
	...
	public static void main(String[] args) throws Exception {
		...
		//b.addFiles(FileFinder.GetAllFiles("src/search", ".txt", true), true /*clear_old_index = false if adding*/);
		b.addFiles(FileFinder.GetAllFiles("src/documents", null, true), true /*clear_old_index = false if adding*/);
